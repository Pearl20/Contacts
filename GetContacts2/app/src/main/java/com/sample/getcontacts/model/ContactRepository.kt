...
import com.sample.getcontacts.db.ContactDao
import com.sample.getcontacts.db.ContactDataBase
import java.util.*

class ContactRepository(private val context: Context) {
    private val contacts: List<Contact>
    var db: ContactDao = ContactDataBase.getInstance(context)?.contactDao()!!
